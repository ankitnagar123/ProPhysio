...
class _NavigateMapViewScreenState extends State<NavigateMapViewScreen> {
  ...
  String lat = Get.parameters["lat"].toString();
  String long = Get.parameters["long"].toString();
  String name = Get.parameters["name"].toString();
  String surname = Get.parameters["surname"].toString();
  String img = Get.parameters["img"].toString();
  String address = Get.parameters["address"].toString();
  String doctorId = Get.parameters["doctorId"].toString();
  Map<MarkerId, Marker> markers = <MarkerId, Marker>{};
              ...
              child: Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      customView.text(
                          "$name $surname", 13, FontWeight.w600, MyColor.black),
                      const SizedBox(
                        height: 3,
                      ),
                      Row(
