      ...
      return Scaffold(
        ...
        body:
          appointmentController.loadingFetch.value?
            Center(child: custom.MyIndicator()):SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  DatePicker(
                    DateTime.now(),
                    initialSelectedDate: DateTime(int.parse(widget.year), int.parse(widget.month), int.parse(widget.day)),
                  ...
                  appointmentController.loadingFetchTime.value
                      ...
                      itemCount: appointmentController.timeList.length,
                      gridDelegate:
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        print(appointmentController.timeList.length);
                        return GestureDetector(
                          onTap: () {
                            setState(() {
                              time = appointmentController
                                  .timeList[index].timeId
                                  .toString();
                              log("time id>$time");
                              selectedCard = index;
                              // print(selectedCard);
                                ...
                                child: Center(
                                    child: Text(
                                      '${appointmentController.timeList[index]
                                          .from
                                          .toString()} - ${appointmentController
                                          .timeList[index].to.toString()}',
                                      style: TextStyle(
                  ...
                  Align(
                      alignment: Alignment.topLeft,
                      child: custom.text(
                          "Visit Charges", 16, FontWeight.w500,
                          MyColor.black)),
                  appointmentController.visitCharge.isEmpty
                    ...
                    child: Text("No visit Charges added by Doctor"),
                      ...
                      itemBuilder: (context, index) {
                        return ListTile(
                          subtitle: Text(appointmentController
                              .visitCharge[index].price
                              .toString()),
                          horizontalTitleGap: 20,
                          visualDensity: const VisualDensity(
                              horizontal: 3, vertical: -4),
                          leading: const Icon(Icons.arrow_circle_right,
                              size: 20, color: MyColor.lightblue),
                          title: Text(appointmentController
                              .visitCharge[index].name
                              .toString()),
