...
class DoctorCancelAppoint extends StatefulWidget {
  const DoctorCancelAppoint({Key? key}) : super(key: key);

  @override
  State<DoctorCancelAppoint> createState() => _DoctorCancelAppointState();
}

class _DoctorCancelAppointState extends State<DoctorCancelAppoint> {
  ...
  void initState() {
    super.initState();
    bookingController.bookingAppointmentCancelList(context, "","");
  }
                                    ...
                                    Expanded(
                                      ...
                                      child: customView.mysButton(
                                        ...
                                        "Today",
                                          ...
                                          bookingController.bookingAppointmentCancelList(context, "",today);
                                    ...
                                    Expanded(
                                      ...
                                      child: customView.mysButton(
                                        ...
                                        "Weekly",
                                          ...
                                          bookingController.bookingAppointmentCancelList(context, "",weekly);
                                    ...
                                    Expanded(
                                      ...
                                      child: customView.mysButton(
                                        ...
                                        "Monthly",
                                          ...
                                          bookingController.bookingAppointmentCancelList(context, "",monthly);
                                          Get.back();
                                        },
                                        selectedCard1 == 2
                                            ? MyColor.primary
                                    ...
                                    Expanded(
                                      ...
                                      child: customView.mysButton(
                                        ...
                                        "Linear",
                                          ...
                                          bookingController.bookingAppointmentCancelList(context, text.linear.tr,"");
                                    ...
                                    Expanded(
                                      ...
                                      child: customView.mysButton(
                                        ...
                                        "Reverse",
                                          ...
                                          bookingController.bookingAppointmentCancelList(context, text.reverse.tr,"");
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Expanded(
                            flex: 1,
                            child: customView.text(text.Cancel.tr, 11.0,
