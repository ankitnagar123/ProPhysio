              ...
              children: [
                ClipRRect(
                  ...
                  child: FadeInImage.assetNetwork(
                    ...
                    image: bookingController.patientProfile.value,
        ...
        body: Column(
          children: [
            Expanded(
                child: SizedBox(
                    height: 300,
                    child: chatController.receivedMsgList.isEmpty?SizedBox():
                    ListView.builder(
                      reverse: true,
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        if (messagectr.text
                            .trim()
                            .isNotEmpty) {
                          chatController.doctorSendingMsgApi(
                              context, patientId, "Text", messagectr
                              .text, () {});
