...
/*new*/
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      registerOfBelongingCtr.text = doctorProfileCtr.registerOfBelonging.value;
    ...
    return SafeArea(
      child: Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Obx(() {
              if(doctorProfileCtr.loading.value){
                return Center(
              ...
              return Column(
                ...
                children: [
                  ...
                  customView.text(
                      "Personal data", 14.0, FontWeight.w500, MyColor.black),
                  SizedBox(
                    height: height * 0.03,
                  ),
                  Row(
                    children: [
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            customView.text(
                                "Your surname", 10.0, FontWeight.w600,
                                MyColor.black),
                            SizedBox(
                              height: height * 0.01,
                            ),
                            customView.myField(
                                context, surename, "Surname",
                                TextInputType.text),
                          ],
                        ),
                      ),
                  ...
                  customView.myField(
                      context, genderCtrl, "Enter gender", TextInputType.text),
                  SizedBox(
                    height: height * 0.03,
                  ),
                  Row(
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            customView.text("Your birth of date", 10.0, FontWeight.w600,
                                MyColor.black),
                            SizedBox(
                              height: height * 0.01,
                            ),
                            customView.myField(
                                context, birthDateController, "birth date", TextInputType.text),
                          ],
                        ),
                      ),
                      const SizedBox(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            customView.text(
                                "Your birthplace", 10.0, FontWeight.w600,
                                MyColor.black),
                            SizedBox(
                              height: height * 0.01,
                            ),
                            customView.myField(
                                context, birthplaceController, "birthplace",
                                TextInputType.text),
                          ],
                        ),
                      ),
...
/*-new-*/
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            customView.text("Your graduation date", 10.0, FontWeight.w600,
                                MyColor.black),
                            SizedBox(
                              height: height * 0.01,
                            ),
                            customView.myField(
                                context, dateOfGraduation, "graduation date", TextInputType.text),
                          ],
                        ),
                      ),
                      const SizedBox(
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                            customView.text(
                                "Your qualification date", 10.0, FontWeight.w600,
                                MyColor.black),
                            SizedBox(
                              height: height * 0.01,
                            ),
                            customView.myField(
                                context, dateOfQualification, "qualification date",
                                TextInputType.text),
                          ],
                        ),
                      ),
          ...
          bottomNavigationBar: Container(
            ...
            child: customView.MyButton(
              ...
              "Save profile",
                  () {
                doctorProfileCtr.doctorProfileUpdate(context, name.text, surename.text,
                    userNameCtrl.text,bioCtrl.text, code,
                    emailCtrl.text, phoneNumberCtrl.text, imagename,
                    baseimage,genderCtrl.text,birthDateController.text,birthplaceController.text,universityAttendedCtr.text,dateOfEnrollmentCtr.text,registerOfBelongingCtr.text,dateOfQualification.text,dateOfGraduation.text);
