  ...
  void bookingAppointmentDetails(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        patientProfile.value = jsonResponse["user_profile"];

        userId.value = jsonResponse["user_id"];
        ...
        bookId.value = jsonResponse["book_ID"];
        patientId.value = jsonResponse["patient_ID"];
