...
/*Doctor Home Page */
  ...
  String addNewCardOrderToPayAppointment =
  ...
  String pleaseSelectPaymentMethodAlreadyEnteredAddCard =
  ...
  String areYouSureWantDeleteCard =
  ...
  String youDonHaveAnyRatingReview =
      "You don’t have any new rating or review to do.";
  ...
  /*PATIENT SIDE CHAT SCREEN 13*/

  String chat = "Chat";
  String searchBetweenYourChats = "Search between your chats";
  String youDonHaveAnyChat = "You don’t have any chat.";
  String deleteChat = "Delete chat";
  String noSelected = "No selected";
  String areYouSureYouWantDeleteChat = "Are you sure you want to delete chat??";
  String call = "Call";
  String enterMessage = "Enter message...";

  /*PATIENT SIDE BOOKING AND ALL SIDE SCREEN*/

  String searchYourAppointments = "Search your appointments";
  String pastAppointments = "Past appointments";
  String youDonHaveAnyUpcoming =
      "You don’t have any upcoming or pending appointment right now. Book an appointment if needed.";
  String doctorInformation = "Doctor information";
  ...
  String youCanContactTheDoctor = "You can contact the Doctor if you want to.";
  String searchAppointment = "Search appointment";
  String upcoming = "Upcoming";
  String pending = "Pending";

  String pastVisits = "Past visits";
  String youDonHaveAnyAppointmentRight =
      "You don’t have any  appointment right now. Book an appointment if needed.";
  String youDonHaveAnyPastAppointment = "You don’t have any past appointment.";
  ...
  String locationServicesDisabledPleaseEnableServices =
      "Location services are disabled. Please enable the services";
  String locationPermissionsDenied = "Location permissions are denied";
  String locationPermissionsPermanentlyRequestPermissions =
      "Location permissions are permanently denied, we cannot request permissions.";
  String setLocation = "Set Location";
  String fromOffice = "From office";
  String setPrice = "Set price";
  String selectPriceRange = "Select price range";
  String editLocation = "Edit location";
  String editAddressCalculateDistance =
      "Edit to address to calculate the distance";
  String setLabel = "Set label";
  String yourUserLabel = "Your user label";
  String enterAddress = "Enter the address";
  String enterCAP = "Enter CAP";
  String yourCap = "Your CAP";
  String addAddressCalculateDistance =
      "Add a new address to calculate the distance";
...
String NoWardAddedCenter = "No ward added by center";
  ...
  String fullSlot = "Doctor not Available";
...
/*Doctor Home Page */
          ...
          addNewCardOrderToPayAppointment:
              "Add a new card in order to pay the appointment.",
          ...
          pleaseSelectPaymentMethodAlreadyEnteredAddCard:
              "Please select a payment method you already entered or add a new card.",
          cardType: "Card type",
          ...
          /* PATIENT SIDE CHAT 13 TARIKH PAGE*/

          chat: "Chat",
          searchBetweenYourChats: "Search between your chats",
          youDonHaveAnyChat: "You don’t have any chat.",
          deleteChat: "Delete chat",
          noSelected: "No selected",
          areYouSureYouWantDeleteChat: "Are you sure you want to delete chat??",
          call: "Call",
          enterMessage: "Enter message...",

          /*PATIENT SIDE BOOKING AND ALL SIDE SCREEN*/

          searchYourAppointments: "Search your appointments",
          pastAppointments: "Past appointments",
          youDonHaveAnyUpcoming:
              "You don’t have any upcoming or pending appointment right now. Book an appointment if needed.",
          ...
          Appointment_cancelled_successfully:
              "Appointment \ncancelled \nsuccessfully!",
          cancelled: "cancelled",
          youCanContactTheDoctor: "You can contact the Doctor if you want to.",
          searchAppointment: "Search appointment",
          upcoming: "Upcoming",
          pending: "Pending",
          pastVisits: "Past visits",
          youDonHaveAnyAppointmentRight:
              "You don’t have any  appointment right now. Book an appointment if needed.",
          youDonHaveAnyPastAppointment: "You don’t have any past appointment.",

          /*PATIENT SIDE FILTER SCREEN*/

          locationServicesDisabledPleaseEnableServices:
              "Location services are disabled. Please enable the services",
          locationPermissionsDenied: "Location permissions are denied",
          locationPermissionsPermanentlyRequestPermissions:
              "Location permissions are permanently denied, we cannot request permissions.",
          ...
          editAddressCalculateDistance:
              "Edit to address to calculate the distance",
          setLabel: "Set label",
          yourUserLabel: "Your user label",
          enterAddress: "Enter the address",
          enterCAP: "Enter CAP",
          yourCap: "Your CAP",
          addAddressCalculateDistance:
              "Add a new address to calculate the distance",
...
/*api respone*/
  ...
  WaitforadminApprove : "Wait for admin Approve",
        ...
        'it_IT': {
          ...
          viewYourPrescriptionMedicalTestMedicines:
              "Visualizza la tua prescrizione, test medico e farmaci",
          qrCode: "QR Codice",
          ...
          addNewCardOrderToPayAppointment:
              "Aggiungi una nuova carta per pagare l'appuntamento.",
          ...
          pleaseSelectPaymentMethodAlreadyEnteredAddCard:
              "Seleziona un metodo di pagamento che hai già inserito o aggiungi una nuova carta.",
          ...
          addCardOrderPayVisits:
              "Aggiungi una nuova carta per pagare le visite.",
          card: "Carta",
          removeCard: "Rimuovi carta",
          areYouSureWantDeleteCard:
              "Sei sicuro di voler cancellare la tua carta?",
          remove: "Rimuovere",
          ...
          youDonHaveAnyRatingReview:
              "Non hai alcuna nuova valutazione o recensione da fare.",
          ...
          chat: "Chiacchierata",
          searchBetweenYourChats: "Cerca tra le tue chat",
          youDonHaveAnyChat: "Non hai alcuna chat.",
          deleteChat: "Elimina chat",
          noSelected: "Nessun selezionato",
          areYouSureYouWantDeleteChat:
          ...
          searchYourAppointments: "Cerca i tuoi appuntamenti",
          pastAppointments: "Appuntamenti passati",
          youDonHaveAnyUpcoming:
              "Al momento non hai appuntamenti imminenti o in sospeso. Prenota un appuntamento se necessario.",
          doctorInformation: "Informazioni medico",
          patient: "Paziente",
          you: "Voi",
          ...
          Appointment_cancelled_successfully:
              "Appuntamento \ncancellato \ncon successo!",
          cancelled: "annullato",
          youCanContactTheDoctor: "Puoi contattare il medico se lo desideri.",
          searchAppointment: "Cerca appuntamento",
          upcoming: "In arrivo",
          pending: "In attesa di",
          pastVisits: "Visite passate",
          youDonHaveAnyAppointmentRight:
              "Non hai nessun appuntamento in questo momento. Prenota un appuntamento se necessario.",
          youDonHaveAnyPastAppointment: "Non hai nessun appuntamento passato.",

          /*PATIENT SIDE FILTER SCREEN*/

          locationServicesDisabledPleaseEnableServices:
              "I servizi di localizzazione sono disattivati. Si prega di abilitare i servizi",
          locationPermissionsDenied:
              "Le autorizzazioni di localizzazione sono negate",
          locationPermissionsPermanentlyRequestPermissions:
              "Le autorizzazioni di localizzazione sono permanentemente negate, non possiamo richiedere autorizzazioni.",
          setLocation: "Imposta posizione",
          fromOffice: "Dall'ufficio",
          setPrice: "Imposta prezzo",
          selectPriceRange: "Seleziona la fascia di prezzo",
          editLocation: "Modifica posizione",
          editAddressCalculateDistance:
              "Modifica l'indirizzo per calcolare la distanza",
          setLabel: "Imposta etichetta",
          yourUserLabel: "La tua etichetta utente",
          enterAddress: "Inserisci l'indirizzo",
          enterCAP: "Inserisci CAP",
          yourCap: "La tua PAC",
          addAddressCalculateDistance:
              "Aggiungi un nuovo indirizzo per calcolare la distanza",
          requiredLabel: "Etichetta obbligatoria",
          ...
          letGo: "Andiamo",
          appointmentWith: "Appuntamento con",
          freeSlot: "Slot gratuito",
          fewSlot: "Pochi slot",
          fullSlot: "slot pieno",
          noTimeSlotAvailableMoment:
              "Nessuna fascia oraria disponibile al momento!",
