  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: Padding(
        ...
        child:drIdMainArray.isEmpty?const Text(""): custom.MyButton(context, "Add ward", () {
          ...
          child: Column(
            children: [
              ...
              Align(
                ...
                child: custom.text(
                    "Enter ward name", 12.0, FontWeight.w600, MyColor.primary1),
              ),
              const SizedBox(
                height: 3.0,
              ),
              custom.myField(
                  context, nameCtr, "name", TextInputType.text),
              SizedBox(
                height: height * 0.03,
              ),
             ...
             if (drIdMainArrayimg.isEmpty) const Text("") else SizedBox(
              ...
              Obx(() {
                if (centerHomeCtr.loadingFetch.value) {
                  return Padding(
                    padding:
                      ...
                      itemBuilder: (context, index) {
                        return GestureDetector(
                           ...
                           /* var id = {
                            ...
                            setState(() {
                              if (drIdArray.contains(index)){
                                drIdArray.remove(index);
                                drIdMainArray.remove(list[index].doctorId);
                                drIdMainArrayimg.remove(list[index].doctorProfile);

                              } else {
                                drIdArray.add(index);
                                drIdMainArray.add(list[index].doctorId);
                                drIdMainArrayimg.add(list[index].doctorProfile);
                          ...
                          child: Card(
                            ...
                            color: drIdArray.contains(index) ?MyColor.primary:MyColor.midgray,
                            elevation: 2.2,
                            child: Row(
                              children: [
                                SizedBox(
