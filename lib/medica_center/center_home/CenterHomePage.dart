               ...
               Padding(
                ...
                child: Align(
                  ...
                  child: GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>CenterAddWardScreen()));
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const CenterDoctorViewScreen()));
                    // Get.toNamed(RouteHelper.getPatientSettingsScreen());
                  },
                  title: custom.text(
                      "Cardiology", 14.0, FontWeight.w500, Colors.black),
                  subtitle: Row(
                    children: [
                      ...
                      custom.text(
                          "3 doctors", 11.0, FontWeight.normal, Colors.black),
                    ],
                  ),
                ),
              ),
