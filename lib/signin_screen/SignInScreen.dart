              ...
              child: Column(
                children: [
                  ...
                  Align(
                    alignment: Alignment.topLeft,
                    child: custom.text(
                        "Enter your username/email", 13, FontWeight.w500,
                        MyColor.primary1),
                  ),
                  SizedBox(
                    height: height * 0.01,
                  ...
                  Align(
                    alignment: Alignment.topLeft,
                    child: custom.text(
                        "Enter your Password", 13, FontWeight.w500,
                        MyColor.primary1),
                  ),
                  SizedBox(
                    height: height * 0.01,
                  ...
                  custom.PasswordField(
                      context, passwordCtr, "Enter Password", TextInputType.text,
                      GestureDetector(
                          onTap: () {
                            setState(() {
                              _isHidden = !_isHidden;
                  ...
                  Row(
                    children: [
                      custom.text(
                          "Forgot password?", 12, FontWeight.w500,
                          MyColor.primary1),
                      GestureDetector(
                        onTap: () {
                        ...
                        child: const Text("Create a new one", style: TextStyle(
                    ...
                    builder: (context, value, child) {
                      return  Obx(() {
                        ...
                        return custom.MyButton(context, "Sign in",() {
                          ...
                          if(validation()){
                            loginCtr.login(context, emailCtr.text, passwordCtr.text);
                          }
                        },value.text.isNotEmpty?MyColor.primary:MyColor.grey,
                            const TextStyle(fontSize: 18, color: MyColor.white));
                      });/*ElevatedButton(
